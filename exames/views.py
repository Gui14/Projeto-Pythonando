...
def solicitar_exames(request):
    ...
    if request.method == 'GET':
        ...
        preco_total = 0
        data = datetime.today()
        data_str = data.strftime("%d de %B")
        
        for i in solicitacao_exames:
            if i.disponivel:
                preco_total += i.preco 
        return render(request, 'solicitar_exames.html', {'tipos_exames': tipos_exames, 'solicitacao_exames': solicitacao_exames, 'preco_total': preco_total, 'data': data_str})
